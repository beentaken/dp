...
#ifdef PRINT_CAMERA_LOCATION
    //debug camera location
    std::cout << "Eye location: " << m_vEye.x << ", " << m_vEye.y << ", " << m_vEye.z << std::endl;
    std::cout << "Lookat location: " << m_vLookAt.x << ", " << m_vLookAt.y << ", " << m_vLookAt.z << std::endl;
#endif
